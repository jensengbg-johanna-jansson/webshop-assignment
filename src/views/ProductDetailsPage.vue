    ...
    <article class="product-details">
      ...
      <div class="message-container">
        <transition name="fade-up">
          <span class="success-message" v-show="showSuccessMsg"
            >Product was added to cart</span
          >
        </transition>
        <transition name="fade-up">
          <span class="error-message" v-show="showErrorMsg"
            >Error: Product could not be added</span
          >
        </transition>
      </div>
...
export default {
  ...
  methods: {
    ...
    async addToCart() {
      if (
        this.isValidToCartRequest() != false &&
