...
it('should show the products images', () => {
  const expectedImage =
    'https://images.unsplash.com/photo-1512436991641-6745cdb1723f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80'
  const wrapper = shallowMount(ProductPage)
  /*    
  Det fungerade inte med dessa 
  let image = wrapper.find("img src")
  let content = image.text(); 
  */
  let image = wrapper.find('img')
  let content = image.attributes().src
